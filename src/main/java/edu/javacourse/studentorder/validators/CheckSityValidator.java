...
import edu.javacourse.studentorder.reg_checkers.FakeCityRegisterChecker;
    ...
    private AnswerSityRegisterItem checkPerson(Person person){
       ...
       AnswerSityRegisterItem.CityError error=null;
        try {
              ...
              status=tmp.isExisting()?AnswerSityRegisterItem.CityStatus.YES: AnswerSityRegisterItem.CityStatus.NO;
